...
void VulkanEngine::init_default_data() {
	...
	//< init_data
	testMeshes = loadGltfMeshes(this, "..\\..\\vulkan-from-scratch\\assets\\basicmesh.glb").value();
}
...
void VulkanEngine::init_background_pipelines()
{
	...
	if (!vkutil::load_shader_module("../../vulkan-from-scratch/shaders/sky.comp.spv", _device, &skyShader)) {
		std::cout << "Error when building the compute shader" << std::endl;
	}
...
void VulkanEngine::init_triangle_pipeline()
{
	...
	if (!vkutil::load_shader_module("../../vulkan-from-scratch/shaders/colored_triangle.frag.spv", _device, &triangleFragShader)) {
	...
	if (!vkutil::load_shader_module("../../vulkan-from-scratch/shaders/colored_triangle.vert.spv", _device, &triangleVertexShader)) {
...
void VulkanEngine::init_mesh_pipeline()
{
	...
	VkShaderModule triangleVertexShader;
	if (!vkutil::load_shader_module("../../vulkan-from-scratch/shaders/colored_triangle_mesh.vert.spv", _device, &triangleVertexShader)) {
		fmt::print("Error when building the triangle vertex shader module");
	}
	else {
		fmt::print("Triangle vertex shader succesfully loaded");
